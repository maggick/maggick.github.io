...
There were two hints on the descripotion of the machine on the vulnhub download
page:
...
We use metasploit to directly have the Drupal exploit:
...
[Fart-knocker](http://matthieukeller.com/2015/06/vulnhub-fart-knocker.html#CVE-2015-1328)
...
We still have the crdential of `www-data`:
...
Then we just run it to gain root privilegies on the box:
...
We launch john againt the file with our partial rockyou list:
