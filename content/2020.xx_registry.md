...
As this is a script the user running it probably don't need to unput a
...
We try to brutforce the password has using john. The hash algorithm is bcrypt and
