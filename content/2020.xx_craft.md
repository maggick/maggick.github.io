...
![git file](/media/2020.xx/craft_1.png)
...
We get only one user because the dbtest.py use the `cursor.fetchone()` function.
...
This user has a private repository containg sensitive information as his private
