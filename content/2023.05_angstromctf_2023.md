...
Date: 05-02-2022 14:25
category:security
tags:security, ctf, web, SSTI
meta:security, ctf, web, SSTI

<img class="align-left" src="content/media/2023.05/angstromctf.png" alt="angstromctf 2023" width="262">
...
using `type[]=image/svg%2bxml`. We also included a SVG file containing a XSS payload (a simple
`alert('XSS')` for now).
...
The application was an authentication form with an impossible login. As the previous challenge a
