...
[here](/media/2020.xx/RemoteConnection.exe).
...
![Strings in the binary](/media/2020.xx/bitlab_8.png)

We put a breakpoint (<F2> on the `Access Denied !!` string).

![Breaking on "Access Denied"](/media/2020.xx/bitlab_9.png)
...
![The putty options at our breakpoint](/media/2020.xx/bitlab_10.png)
