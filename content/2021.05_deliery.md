...
![Homepage](/media/2021.05/delivery_01.png)
...
![help desk page](/media/2021.05/delivery_02.png)

We create a ticket and got an associated email adresse with the <ticket number>@delivery.htb

![associated email address](/media/2021.05/delivery_03.png)

we create an account on mettermost with this email and got the verification URL on the ticket

![Registering on mattermost email](/media/2021.05/delivery_035.png)


![mattermost verification link](/media/2021.05/delivery_04.png)
...
![OSticket panel](/media/2021.05/delivery_05.png)
